...
describe('User Component Testing', () => {
    ...
    describe('User Service Testing', () => {
        it.skip('Test for User Create', async () => {
            const mockSave = jest.fn(() => "success");
        ...
        it.skip('Test for User Login', async () => {
            await expect(userService.Login(`hussam@yopmail.com`, "123456")).resolves.toHaveProperty('user');
        })
        it('Test for Reset Email', async () => {
            await expect(userService.Reset(`hussam@yopmail.com`)).resolves.toBe('success');
        })
    })
})